...
resource "aws_iam_role" "ecs_task_execution_role" {
  name = "ecs-task-execution-role-fluentbit"
...
resource "aws_iam_role" "ecs_instance_role" {
  name = "ecs-instance-role-fluentbit"
...
resource "aws_iam_role" "terminate_lifecyclehook" {
  name        = "asg-lifecyclehook-fluentbit"
...
resource "aws_iam_policy" "access_asgrole_policy" {
  name = "cloudformation-access-asgrole-fluentbit"
